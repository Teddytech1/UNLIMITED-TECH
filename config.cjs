...
const config = {
  ...
  STATUS_READ_MSG: process.env.STATUS_READ_MSG || 'Status Viewed by UNLIMITED TECH',
  ...
  OWNER_NAME: process.env.OWNER_NAME || "Kibet",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "254799963583",
  SUDO_NUMBER: process.env.SUDO_NUMBER || "254799963583",
